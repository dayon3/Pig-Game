...
document.querySelector(".btn-hold").addEventListener("click", function() {
	if (gamePlaying) {
		...
		if (scores[activePlayer] >= 100) {
			var activePlayerPanelDOM = document.querySelector(
			...
			activePlayerPanelDOM.classList.add("winner");
			activePlayerPanelDOM.classList.remove("active");
...
2. Add an input fiels to the HTML where players can set the winning score, so that they can cahnge the
predefined score of 100. (HINT: You can read that value withh the .value property in JavaScript. This is a
